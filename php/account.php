			...
			<?php
				...
				if($logged=='in'){
					...
					if(isset($rows[0]["email"])){
						echo '<p class="text-muted">Email: ' . $rows[0]["email"].' <a onclick="javascript:goToUrl(window.location.href,\'page\',\'change\')" class="btn btn-info btn-xs" role="button">'.translate_get($_SESSION['lang'],"change").'</a></p>';
					}
					...
					if(isset($rows[0]["FirstName"])){
						echo '<p class="text-muted">'.translate_get($_SESSION['lang'],"first_name").': ' . $rows[0]["FirstName"].' <a onclick="javascript:goToUrl(window.location.href,\'page\',\'change\')" class="btn btn-info btn-xs" role="button">'.translate_get($_SESSION['lang'],"change").'</a></p>';
					}
					if(isset($rows[0]["LastName"])){
						echo '<p class="text-muted">'.translate_get($_SESSION['lang'],"last_name").': ' . $rows[0]["LastName"].' <a onclick="javascript:goToUrl(window.location.href,\'page\',\'change\')" class="btn btn-info btn-xs" role="button">'.translate_get($_SESSION['lang'],"change").'</a></p>';
					}
