							...
							echo '<div class="col-sm-4 col-lg-4 col-md-4">
								<div class="thumbnail">
									...
									<div class="panel-footer">
										<h4><a href="index.php?page=item&item='.$calc[$i]['ID'].'&cat='.$_GET['type'].'">'.$calc[$i]['Firma'].' '.$calc[$i]['Model'].' '.$calc[$i]['Serie'].'</a><input onclick="addToCart(\''.$_GET['type'].'\',\''.$calc[$i]['ID'].'\',\''.$_SESSION['user_id'].'\',\'1\')" width="30" height="30" type="image" src="img/add-to-cart.png"></input></h4>
